...
// With if Or With Enums :)

short CompareDateFunction(stDate Date1, stDate Date2)
{
    if (IsDate1BeforeDate2(Date1, Date2))
        return -1;
    else if (IsDate1EqualesToDate2(Date1, Date2))
        return 0;
    else
        return 1;
}
...
int main()
{
    ...
    cout << "\nCompare Result = " << CompareDateFunction(Date1, Date2) << endl;
